...
<table width="323" height="60" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="27" background="images/main_title.jpg">&nbsp;&nbsp;
          <span style="font-weight:bold; color:#DD6400"><%=typeArray[i][1]%>
          </span><a style="color:#FA6E00;" href="song.do?action=songQuery&songType_more=<%=typeArray[i][0]%>">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;更多>>
          </a>&nbsp;</td>
       </tr>
	...
	<logic:iterate id="song" name="<%=requestPara%>" type="com.model.SongForm" scope="request" indexId="ind">
      <tr>
        ...
        <a href="#" ><bean:write name="song" property="songName" filter="true"/></a></td>
        <td class="word_gray1">&nbsp;
       <a href="#" ><bean:write name="song" property="singer" filter="true"/></a></td>
